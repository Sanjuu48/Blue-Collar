...
import {Sparkles, Scissors, Hash} from 'lucide-react'
        ...
        <div className="h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700">
            <form onSubmit={onSubmitHandler} className="w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200">
                <div className="flex items-center gap-3">
                    ...
                    <h1 className="text-xl font-semibold">Object Remeoval</h1>
                </div>
                ...
                placeholder="e.g. wardrobe, table, chair etc, Only Single Object name" required/>

                <br/>
                <button
                    disabled={loading}
                    className="w-full flex justify-center items-center gap-2 
                    bg-linear-to-r from-[#417DF6] to-[#8E37EB] 
